...
Две прежние slow-таблицы уже объединены. На сайте видна одна таблица `⏳ Сейчас в медленной генерации — Topview`: список сцен остаётся каноническим из Drive/master, а Topview добавляет технический статус и оценочные данные. Вторую видимую slow-таблицу не возвращать без отдельной причины.
