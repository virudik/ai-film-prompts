...
Scene 2 технически завершена в Topview и по прямому решению пользователя снята с slow-lock; её prompt пока остаётся active. Scenes 6 и 7 больше не актуальны и удалены из active master. Не восстанавливать их автоматически без нового явного запроса пользователя.
