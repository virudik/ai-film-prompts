...
- **⏳ 4** сцены сейчас в медленной генерации: **4, 17, 19, 20** — повторно не запускать до результата/ошибки или отдельного решения пользователя.
