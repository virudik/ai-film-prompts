...
- **⏳ 5** сцен сейчас в медленной генерации: **3, 4, 5, 17, 19** — повторно не запускать до результата/ошибки или отдельного решения пользователя.
- **Последние оформленные активные сцены:** 19–20.
- **Последняя полная синхронизация:** **22.09.2026 · 11:33 (+03:00)**.
