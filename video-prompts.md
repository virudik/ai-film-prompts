...
По состоянию на 18 сентября 2026 уже запущены и могут считаться несколько дней: **сцены 2, 6, 12, 14, 15 и 18**. Пока не получен результат или явная ошибка генерации, **не отправлять эти сцены повторно**, даже если их промты остаются в активном мастер-файле.
