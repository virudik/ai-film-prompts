...
- **⏳ 5** сцен сейчас в медленной генерации: **3, 4, 5, 13, 19** — повторно не запускать до результата/ошибки или отдельного решения пользователя.
