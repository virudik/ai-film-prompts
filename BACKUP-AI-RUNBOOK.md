...
- крупно **`M из 6`** занятых Topview task-slots, ниже **`Свободно Y · N сцен`**;
- detailed header **`занято M из 6 · свободно Y · timestamp`**;
- work summary показывает только count, без raw `W5…W15`;
