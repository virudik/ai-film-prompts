...
**Не использовать для сцен с русским разговорным диалогом.** В текущем workflow Seedance 2.5 считается ненадёжным для естественной русской речи/произношения и lip sync. Если в сцене есть хотя бы одна слышимая реплика на русском, целевой движок по умолчанию и обязательному правилу проекта — **Wan 3**. Исключение возможно только по новой прямой команде пользователя для конкретной сцены.

Обычно Seedance 2.5 хорошо работает для сцен без русского разговорного диалога: подробная режиссёрская структура, точное распределение референсов, ясная временная последовательность, controlled camera motion и native audio instructions.
...
**Все сцены с слышимым русским разговорным диалогом направлять в Wan 3.** Это постоянное engine-routing правило проекта: Seedance 2.5 плохо справляется с русской речью, поэтому русский dialogue = Wan 3, если пользователь явно не распорядился иначе для конкретной сцены. Это правило относится и к новым сценам, и к существенной переработке существующих русскоязычных dialogue scenes.

Особенно внимательно контролировать live-action realism, identity stability, естественное русское произношение, mouth/lip sync, материальность и отсутствие мультяшного/глянцевого CG look, если предыдущий результат имел такой дефект.
...
## CONTINUOUS PROMPT KNOWLEDGE TRANSFER
